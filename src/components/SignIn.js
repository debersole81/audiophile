      ...
      <Form className="authform">
        ...
        <Form.Row className="row authform-pw-row">
          <Col className="col authform-pw-link-col">
            ...
            <Button variant="link" onClick={resetPasswordLink}>
              Reset password
            </Button>
          </Col>
        </Form.Row>
        <Form.Row className="row authform-row">
          <Col className="col" xs={12} sm={12} md={12} lg={12} xl={12}>
            <Button variant="dark" onClick={signIn} block>
              Sign In
            </Button>
            <Button variant="dark" onClick={guestSignIn} block>
              Continue as Guest
            </Button>
          </Col>
          <Col
            className="col authform-link-col"
            xs={12}
            sm={12}
            md={12}
            lg={12}
          ...
          >
            ...
            <Button variant="link" onClick={signUpLink}>
              Sign up
            </Button>
          </Col>
        </Form.Row>
    ...
    <Form className="authform-mobile">
      ...
      {width > 370 && width < breakpoint ? (
        ...
        <Form.Row className="row authform-pw-row-mobile">
          <Col className="col" xs={12} sm={12} md={12} lg={12} xl={12}>
            <Button variant="link" size="sm" onClick={resetPasswordLink} block>
      ...
      <Form.Row className="row authform-row">
        <Col className="col" xs={12} sm={12} md={12} lg={12} xl={12}>
          <Button variant="dark" size="sm" onClick={signIn} block>
            Sign In
          </Button>
          <Button variant="dark" size="sm" onClick={guestSignIn} block>
            Continue as Guest
          </Button>
        </Col>
        <Col className="col mt-2" xs={12} sm={12} md={12} lg={12} xl={12}>
          <Button variant="light" size="sm" onClick={signUpLink} block>
            Sign Up
          </Button>
        </Col>
      </Form.Row>
