  ...
  for (let i = 1; i <= searchResultsPagination.pages; i++) {
    ...
    pages.push(
      <Pagination.Item
        ...
        onClick={handleCurrentSearchResultsPage}
      >
        {i}
      </Pagination.Item>
    );
          ...
          <Col className="col">
            <Pagination className="mt-3 flex-wrap justify-content-center">
              <Pagination.Prev
                ...
                onClick={previousSearchResultsPageMobile}
              />
              {pages.map((page) =>
                page.props.id < searchResultsMaxPagesMobile + 1 &&
                page.props.id > searchResultsMinPagesMobile
                  ? page
                  : null
              )}
              <Pagination.Next
                ...
                onClick={nextSearchResultsPageMobile}
              />
            </Pagination>
          </Col>
        </Row>
