...
function ConfirmSignUp(props) {
      ...
      <Form className="authaccount-form">
        ...
        <Form.Row className="row authaccount-authcode-row">
          <Col className="col authaccount-authcode-col">
            <p>Lost your code?</p>
            <Button variant="link" onClick={resendSignUpCodeLink}>
              Resend code
            </Button>
          </Col>
        </Form.Row>
        <Form.Row className="row authaccount-link-row">
          <Col className="col" xs={12} sm={12} md={12} lg={12} xl={12}>
            <Button variant="dark" onClick={confirmSignUp} block>
              Confirm
            </Button>
          </Col>
          <Col
  ...
  return (
    <Form className="authaccount-form-mobile">
        ...
        <Form.Row className="row authaccount-authcode-row-mobile">
          <Col className="col" xs={12} sm={12} md={12} lg={12} xl={12}>
            <Button
              variant="link"
              size="sm"
              onClick={resendSignUpCodeLink}
              block
            >
              Lost your code? Resend
            </Button>
          </Col>
        </Form.Row>
      )}
      <Form.Row className="row authaccount-link-row">
        <Col className="col" xs={12} sm={12} md={12} lg={12} xl={12}>
          <Button variant="dark" size="sm" onClick={confirmSignUp} block>
            Confirm
          </Button>
        </Col>
