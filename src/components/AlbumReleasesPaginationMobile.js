        ...
        <Col className="col">
          <Pagination className="flex-wrap justify-content-center">
            <Pagination.Prev
              ...
              onClick={previousAlbumReleasesPageMobile}
            />
            {pages.map((page) =>
              page.props.id < albumReleasesMaxPagesMobile + 1 &&
              page.props.id > albumReleasesMinPagesMobile
                ? page
                : null
            )}
            <Pagination.Next
              ...
              onClick={nextAlbumReleasesPageMobile}
            />
          </Pagination>
        </Col>
      </Row>
